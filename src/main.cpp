...
int main(int argc, char** argv) {
    ...
    for (int i = 1; i < argc; ++i) {
        ...
        else if (std::strcmp(a, "--frames") == 0) frames = std::atoi(need(a));
        else if (std::strcmp(a, "--width") == 0) width = std::atoi(need(a));
        else if (std::strcmp(a, "--height") == 0) height = std::atoi(need(a));
